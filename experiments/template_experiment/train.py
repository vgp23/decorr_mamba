...
if __name__ == "__main__":
	...
	print(f"Creating model with following properties:\n{mamba_args}\n")
	...
	train_args = TrainingArgs(
	    n_epochs=10, L=L, B=B, lr=1*1.5e-3, **default_train_args.lm_args, warmup_epochs=2)
	print(f"Training with following training arguments:\n{train_args}\n")

	# datasets sent to the device specified in mamba_args by default 
	datasets = LanguageDatasetMaker(seqs, mamba_args, train_args, total_dataset_frac=0.2,
